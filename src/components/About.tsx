        ...
        {(
          [
            ...
            },
            {
              ...
              className:
                'w-1/3 h-1/6 sm:h-1/5 data-[open=true]:w-full data-[open=true]:sm:w-3/4 data-[open=true]:h-[40%] data-[open=true]:lg:h-1/3 border sm:border-2 md:border-[0.188rem] data-[open=true]:border-title-purple',
            },
          ] as TitleProps[]
        ).map(({ id, ...rest }) => (
