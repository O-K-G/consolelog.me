...
export default function Attribution() {
  ...
  return (
    <button
      type="button"
      className="z-10 uppercase outline-hidden lg:cursor-pointer font-bebas-neue text-white hover:text-title-purple active:text-title-purple-dark focus:text-title-purple text-base sm:text-xl md:text-4xl xl:text-6xl"
