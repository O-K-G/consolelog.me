...
export default function Title({
  ...
  topLabel,
  bottomLabel,
  animationClassName = "before:animate-typing-caret",
  ...
  return (
    <div className={`center-elements flex-col ${className}`}>
      ...
      <Component
        className={`py-2 title-typing-animation sm:py-4 px-2 uppercase drop-shadow-purple-glow sm:drop-shadow-purple-glow-sm text-center ${animationClassName} ${selectedVariantClassName[variant]}`}
      >
        {children}
      </Component>
