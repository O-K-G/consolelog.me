...
export default function AboutTargetIcon({
  ...
  return (
    ...
    >
      <div
        data-open={open}
        className="data-[open=false]:before:bg-white data-[open=false]:border-white data-[open=false]:after:bg-white data-[open=true]:before:bg-title-purple data-[open=true]:border-title-purple data-[open=true]:after:bg-title-purple transition-1000 before:transition-1000 after:transition-1000 data-[open]:group-hover:before:bg-orange-300 data-[open]:group-active:before:bg-red-400 before:w-0.5 md:before:w-1 before:h-2 before:absolute before:-top-2 before:right-0 border-double border-t-[6px] border-l-[6px] md:border-t-8 md:border-l-8 data-[open]:group-hover:border-orange-300 data-[open]:group-active:border-red-400 size-full relative data-[open]:group-hover:after:bg-orange-300 data-[open]:group-active:after:bg-red-400 after:w-2 after:h-0.5 md:after:h-1 after:absolute after:bottom-0 after:-left-2"
      />
    </div>
  );
}
