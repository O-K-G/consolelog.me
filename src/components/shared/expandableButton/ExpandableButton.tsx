    ...
    <div className='z-10 container-type-size p-6 h-full w-full sm:w-9/12 md:w-10/12 relative max-h-[80%] center-elements'>
      ...
      >
        ...
        <button
          ...
          aria-expanded={open}
          data-open={open}
          className={`transition-300 border-x border-transparent outline-none overflow-x-hidden data-[open=false]:overflow-y-hidden data-[open=true]:overflow-y-auto size-full data-[open=false]:closed-expandable-button data-[open=true]:opened-expandable-button ${
            !isAnimationEnd
              ? ''
